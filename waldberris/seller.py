...
class ParserWB:
    ...
    def __get_seller_id(self, url):
        ...
        print(seller_id.products[0].supplierId)
    ...
    def __create_csv():
        with open("wb_data.csv", mode="w", newline="") as file:
            ...
            writer.writerow(
                ['id', 'название', 'цена', 'бренд', 'скидка', 'рейтинг', 'в наличии',
                 'id продавца', 'рейтинг'])
...
def main():
    ParserWB("https://www.wildberries.ru/catalog/13037768/detail.aspx").parse()
